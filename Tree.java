...
public class Tree {
        private Node root;
    private Node seccessor;
    private int treverseType;
	...
	if (current.leftChild == null && current.rightChild == null) {
        ...
        Node successor = getSeccessor (current);
        if (current == root) {
            root = successor;
        } else if (isLeftChild) {
    ...
    private Node getSeccessor(Node current) {
    ...
    private Node getSuccessor (Node delNode) {
        ...
        while (current != null) {
            Node successorPatent = successor;
            seccessor = current;
            current = current.leftChild;
        }
    ...
    public void displayTree() {
        ...
        int nBlanks = 32;
        boolean isRowEmpty = flase; System.out.println(
        "..............................................."
        );
